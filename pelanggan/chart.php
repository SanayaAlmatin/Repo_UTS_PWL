...
<body>
  ...
  <div class="container my-5">
    <table class="table table-hover striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?=$subtotal?></td>
          <td><a href="hapus_cart.php?id=<?=$key_produk?>" class="btn btn-danger"><strong>Delete</strong></a></td>
        </tr>
    ...
    <a href="checkout.html" style="background-color: #FFB200; color:#fff;" class="btn ">Check Out</a>
  </div>
